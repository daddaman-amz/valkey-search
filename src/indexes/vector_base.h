...
class PrefilterEvaluator : public query::Evaluator {
 ...
 private:
  query::EvaluationResult EvaluateTags(const query::TagPredicate& predicate) override;
  query::EvaluationResult EvaluateNumeric(const query::NumericPredicate& predicate) override;
  query::EvaluationResult EvaluateText(const query::TextPredicate& predicate) override;
